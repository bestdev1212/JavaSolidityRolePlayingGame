 ...
 * @GTID 903724432
 *
 * Collaborators: I worked alone using only course materials on this project.
...
public class PatternMatching {
    ...
    public static int[] buildFailureTable(CharSequence pattern,
        ...
        if (pattern == null || comparator == null) {
            throw new Illegal ArgumentException("Error, comparator/pattern is null");
            ...
            while ( j >= 0 && comparator.compare(text.charAt(i + j), 
                ...
                if (j == -1) {
                    ...
                    if (map.containsKey(text.charAt(i + j))) {
                        shifted = map.get(text.charAt(i + j));
                    } else {
                        shifted = - 1;
                    }
